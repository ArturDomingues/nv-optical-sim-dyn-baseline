...
# Base curve hues (teal, gold, green, pink, purple, orange, blue, magenta).
BASE_COLORS = [
...
def use_dark_theme(enable: bool = True) -> None:
    ...
    if not enable:
        ...
        return
    plt.rcParams.update({
        "figure.facecolor": _DARK_BG, "axes.facecolor": _DARK_BG,
        "savefig.facecolor": _DARK_BG, "axes.edgecolor": "white",
        "axes.labelcolor": "white", "axes.titlecolor": "white",
        "figure.titlesize": "large", "figure.edgecolor": _DARK_BG,
        "text.color": "white", "xtick.color": "white", "ytick.color": "white",
        "legend.facecolor": _DARK_BG, "legend.edgecolor": "white",
        "legend.labelcolor": "white", "grid.color": "#3A3F5C",
...
def use_light_theme() -> None:
    ...
    plt.rcParams.update({
        ...
        "savefig.facecolor": "white", "axes.edgecolor": _LIGHT_INK,
        "axes.labelcolor": _LIGHT_INK, "axes.titlecolor": _LIGHT_INK,
        "text.color": _LIGHT_INK, "xtick.color": _LIGHT_INK, "ytick.color": _LIGHT_INK,
        "legend.edgecolor": _LIGHT_INK, "legend.labelcolor": _LIGHT_INK,
